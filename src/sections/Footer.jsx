...
const socials = [
{Icon: FaInstagram , label : "Instagram" , href : "https://www.instagram.com/khushieee__46/" },
{Icon: FaLinkedin , label : "LinkedIn" , href : "https://www.linkedin.com/in/khushisaini23/" },
{Icon: FaGithub , label : "GitHub" , href : "https://github.com/KhushiSaini23" },
]
  ...
  return(
    ...
    <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(50%_55%_at_30%_70%,rgba(16,185,129,0.30),transparent_70%)]"/> 
      ...
      >
        ...
        <p className="text-gray-30 italic max-w-xl ">
            &quot;Success is when preparation meets opportunity.&quot;
        </p>

        <p className="text-xs text-gray-400">
          &copy;{new Date().getFullYear()} Khushi Saini. All rights reserved.
        </p>
