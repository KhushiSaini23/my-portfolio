  ...
  
{
        ...
        link: "https://chai-meet-8jso.vercel.app/",
        bgColor: "#3884d3",
...
style ={{
  position : "relative",
  zIndex : 0,
  filter : "drop-shadow(0,16px 40pxrgba(0,0,0,0.65)",
...
style={{
  zIndex: 11,
  background: "linear-gradient(180deg , rgba(0,0,0,0.12) 0%, rgba(0,0,0,0.0) 40%)"
}}
>
</div> 
