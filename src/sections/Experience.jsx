...
const experiences = [
  {
    ...
    duration: "2024 - 2026",
    description:
      "Specialized in frontend development with React.js, JavaScript, and responsive web design, along with basic backend and API knowledge.",
  },

  {
    role: "Bachelor of Science (B.Sc)",
    company: "Mahatma Jyotiba Phule Rohilkhand University",
    duration: "2021 - 2024",
    description:
      "Developed problem-solving, analytical, and learning skills through science-focused education, which later supported the transition into the tech field.",
  },

  {
    role: "Higher Secondary Education (12th)",
    company:
      "Priyanka Modern Senior Secondary School, Dhampur, Uttar Pradesh",
    duration: "2020 - 2021",
    description:
      "Completed higher secondary education with a focus on academic growth and foundational learning.",
  },
];
  ...
  return (
    <div className="relative flex items-start">
      ...
      >
        ...
        <p className="text-sm text-gray-300 break-words mt-4 leading-7">
          {exp.description}
        </p>
...
//                 <div className="relative flex flex-col gap-10 ml-10 mt-6 p-28">
//                     {experiences.map((exp,idx) => (
//                         <ExperienceItem
//                         key={idx}
//                         exp={exp}
