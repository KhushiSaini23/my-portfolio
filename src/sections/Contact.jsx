...
<div className="flex flex-col">
    ...
    >
        ...
        <option value="Web Development" className="text-black hover:bg-blue-500">
        Web Development
        </option>

        <option value="Mobile Application" className="text-black hover:bg-blue-500">
        Mobile Application
        </option>

        <option value="other" className="text-black hover:bg-blue-500">
        Others
        </option>
