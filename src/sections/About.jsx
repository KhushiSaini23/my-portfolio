...
>
 ...
 transition={{type:"spring" , stifness:200 , damping:18}}
>
<img src={p} alt="profile" className="absolute inset-0" />  
  </motion.div>

  <div className="flex-1 flex flex-col jstify-center text-center md:text-left">
    ...
    I design and build modern, responsive websites with a strong focus on clean UI and smooth user experience. 
    I specialize in creating visually appealing interfaces using React, JavaScript, and Tailwind CSS, along with basic backend integration to bring ideas to life.
...
>
  ...
  <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
   I’m a Web Designer and Frontend Developer — passionate about creating modern, responsive websites with clean UI and smooth user experience.
  </p>
  <p className="mt-4 text-gray-400 text-base sm:text-lg">
   I enjoy turning ideas into user-friendly, visually appealing interfaces while continuously improving my frontend and backend development skills.
  </p>
</motion.div>
